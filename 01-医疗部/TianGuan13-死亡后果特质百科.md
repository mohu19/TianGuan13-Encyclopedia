...
> **范围**: 死亡后果特质（Death Consequences / 死亡衰减紊乱）——死亡后身体机能随时间衰减的机制，含 10 节完整数值。
>
...
外部信号: `COMSIG_MAIN_SM_DELAMINATING`（signals.dm:43，超物质熔毁紧急停止系统使用，详见《超物质熔毁紧急停止百科》）。
